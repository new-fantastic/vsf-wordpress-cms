<template>
  <div
    ...
    :class="{
      ...
      'width--auto' : data.wysiwyg_options.inner_layout.width == 'auto',
      'width--50' : data.wysiwyg_options.inner_layout.width == '50',
      'width--100' : data.wysiwyg_options.inner_layout.width == '100'
    }"
  >
    <div
